...
document.addEventListener("DOMContentLoaded", function () {
	...
	document
		...
		.addEventListener("click", function () {
			document.querySelector("#middle-right").style.backgroundColor =
				"slateblue"
	...
	document
		...
		.addEventListener("click", function () {
			document.querySelector("#bottom-middle").style.backgroundColor =
				"slateblue"
	...
	document
		...
		.addEventListener("click", function () {
			document.querySelector("#bottom-right").style.backgroundColor =
				"slateblue"
	...
	document.querySelector("#clear").addEventListener("click", function () {
		...
		endGame.innerText =
			"Player 1 is X. Player 2 is O. Click an empty square on the board to place your piece. Player 1 starts."
	})
})
